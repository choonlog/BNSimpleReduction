...
# BNGenerator
BNGenerator is executed independently of BNSimple, and is a software that generates a random Boolean network using Boolean logic of 78 Boolean networks in the Cell Collective (https://cellcollective.org/).
